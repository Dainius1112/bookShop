                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user_update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="date" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{ $user->birthday ?? old('birthday') }}"  autocomplete="birthday">
