                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <form class="form-inline my-2 my-lg-0" method="GET" action="{{ route('gallery') }}">
                            ...
                            <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" value="{{ request()->search ?? request()->cookie('search') }}" name='search'>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('edit_user') }}">User settings</a>
